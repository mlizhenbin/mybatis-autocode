 ...
 */
public class ServiceImplGenerator extends BaseGenerator implements Generator {
    ...
    public String initTemplateName() {
        return  GeneratorTemplate.TL_SERVICE_IMPL;
    }
    ...
    public String initPath(GeneratorContext generatorContext) {
        ...
        return FileUtils.getPackageDirectory("service", properties)
